...
server = app.server
#CREATE DF
df = pd.read_csv('https://raw.githubusercontent.com/guiconci/wb_plan/main/plan.csv')
df.set_index('id',inplace=True, drop=False)


df2 = pd.read_csv('https://raw.githubusercontent.com/guiconci/wb_plan/main/plan.csv')
